...
describe "beerlist page" do
  ...
  it "have beers sorted alphabetical order by name", :js => true do
    visit beerlist_path
  ...
  it "clicking style should sort styles in alphabetical order", :js => true do
    visit beerlist_path
    click_link ('style')
    ...
    it "clicking brewery should sort breweries in alphabetical order", :js => true do
    visit beerlist_path
    click_link ('brewery')
